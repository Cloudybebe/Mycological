...
lichen palette. A pixelated amoeboid sheet advances inward from the screen edges with broad lobes and a fine exploratory fringe, then resolves into a visibly crawling cellular transport network with irregular junction swellings, anchored heavy source channels, traveling expansion and contraction waves, moving wet highlights, and rounded six-color lichen shading that blends continuously from warm brown-olive rims through mustard and gold bodies to pale wet highlights in one render pass. The network grows over the first 12 seconds and retracts over the
