...
public final class ModItems {
    ...
    public static final DeferredItem<BlockItem> PROTOTAXIES_SPROUT_LARGE = ITEMS.registerSimpleBlockItem(ModBlocks.PROTOTAXIES_SPROUT_LARGE);
    public static final DeferredItem<BlockItem> PROTOTAXIES_SPROUT_TOP = ITEMS.registerSimpleBlockItem(ModBlocks.PROTOTAXIES_SPROUT_TOP);
