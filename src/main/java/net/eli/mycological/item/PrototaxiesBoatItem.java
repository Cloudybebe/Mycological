...
public class PrototaxiesBoatItem extends Item {
    private static final Predicate<Entity> ENTITY_PREDICATE = EntitySelector.NO_SPECTATORS.and(Entity::isPickable);

    public PrototaxiesBoatItem(Item.Properties properties) {
        super(properties);
    ...
    private static Boat getBoat(Level level, HitResult hitResult, ItemStack stack, Player player) {
        Vec3 vec3 = hitResult.getLocation();
        Boat boat = new net.eli.mycological.entity.PrototaxiesBoat(ModEntities.PROTOTAXIES_BOAT.get(), level);
